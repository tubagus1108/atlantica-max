    ...
    <div class="nk-header-title nk-header-title-sm nk-header-title-parallax nk-header-title-parallax-opacity">
        ...
        <div class="nk-header-table">
            <div class="nk-header-table-cell">
                <div class="container">
                    <h1 class="nk-title">{{ __('reset_password.title') }}</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row vertical-gap lg-gap">
            ...
            <div class="col-md-6">
                <div class="nk-box-3 bg-dark-1">
                    ...
                    @endif
                    <form class="nk-form nk-form-style-1" method="POST" action="{{ route('reset-password.post') }}">
                        @csrf

                        <input class="form-control" type="password" placeholder="{{ __('reset_password.password_old') }}"
                            name="password_old" id="password_old" value="{{ old('password_old') }}"
                            autocomplete="password_old" autofocus required>

                        <div class="nk-gap-2"></div>

                        <input class="form-control" type="password"
                            placeholder="{{ __('reset_password.password_confirm') }}" name="password_confirmation"
                            id="password_confirm" autocomplete="password_confirm" required>

                        <div class="nk-gap-2"></div>

                        <input class="form-control" type="password" placeholder="{{ __('reset_password.password_new') }}"
                            name="password" id="password" autocomplete="password" required>

                        <div class="nk-gap-2"></div>

                        <button class="nk-btn nk-btn-color-white link-effect-4 float-right" type="submit">Change
                            Password</button>
