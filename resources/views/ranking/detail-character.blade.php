					...
					<li>
						...
						<div class="nk-social-friends-content">
							<div class="nk-social-friends-info">
								...
								<div class="nk-social-friends-name">Mana&nbsp;<span class="nk-social-friends-meta">{{ number_format($data[0]->mana) }}</span></div>
								<div class="nk-social-friends-name">Total Play Time&nbsp;<span class="nk-social-friends-meta">{{ floor($data[0]->play_second / 3600) }} Hour(s)</span></div>
