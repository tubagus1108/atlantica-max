...
.relative-container {
    ...
    <div class="item-container">
        ...
        <div id="item-mall-nav-wrap">
            <ul id="item-mall-nav">
                <li class="add-divider"><a href="{{ url('item/CONSUMABLES') }}">CONSUMABLES</a></li>
                <li class="add-divider"><a href="{{ url('item/BOX') }}">BOX</a></li>
                <li class="add-divider"><a href="{{ url('item/CARD') }}">CARD</a></li>
                <li class="add-divider"><a href="{{ url('item/SEALED_ORB') }}">SEALED ORB</a></li>
            </ul>
            <ul id="item-mall-nav">
                <li class="add-divider"><a href="{{ url('item/EQUIPMENT') }}">EQUIPMENT</a></li>
                <li class="add-divider"><a href="{{ url('item/MERC_PACK') }}">MERC PACK</a></li>
                <li>
                    <div style="visibility: hidden"></div>
                    <div style="visibility: hidden">M</div>
                </li>
                <li class="add-divider"><a href="{{ url('item/BOOK') }}">BOOK</a></li>
                <li class="add-divider"><a href="{{ url('item/EVENT') }}">EVENT</a></li>
            </ul>
        </div>
        ...
        <div class="items-list clearfix">
            ...
            <div class="item-box product" data-productno="{{ $product->itemid }}">
                ...
                <div class="item-info">
                    ...
                    <p>{{ $product->name }}</p>
                    <a>
                        <img width="30%" src="{{ asset('assets/images/itemmall/img_shop/' . $product->name . $product->image) }}"
                            alt="{{ $product->name }}"
